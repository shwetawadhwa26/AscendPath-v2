...
// 						For Sales <span className="text-clay">Reps</span>
// 					</h1>
// 					<p className="mt-8 text-lg font-medium text-taupe max-w-2xl mx-auto">
// 						Turn your talent into $5-10K/month opportunities. Watch the video below to learn how our placement system connects you with top-tier offers.
// 					</p>
...
// 					{/* <div className="mt-16 mx-auto max-w-10xl"> */}
// 					<div>
// 						<VSLPlayer videoId="18ef8b4452a0efe4ba019aa02a355d6b" />
// 					</div>
// 				</div>
