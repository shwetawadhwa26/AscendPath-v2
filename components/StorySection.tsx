...
// 				<svg
// 					aria-hidden="true"
// 					className="absolute bottom-0 left-[max(50%,25rem)] h-256 w-512 -translate-x-1/2 mask-[radial-gradient(24rem_24rem_at_center,white,transparent)] stroke-gray-200 dark:stroke-gray-800">
// 					<defs>
// 						<pattern
// 							x="50%"
// 							y={-1}
...
// 						alt="Harry's journey from struggle to success"
// 						src="https://imagedelivery.net/LtFu_2qdyYBevDjSRi4ZEg/a4a1134b-515c-45ab-88ad-cce0353e0000/public"
// 						className="w-full lg:w-216 h-64 lg:h-287.5 object-cover object-top rounded-xl bg-gray-900 shadow-xl ring-1 ring-gray-400/10 dark:bg-gray-800 dark:ring-white/10"
// 					/>
// 				</div>
// 				<div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
// 					<div className="lg:pr-4">
...
// 									<TrophyIcon
// 										aria-hidden="true"
// 										className="mt-1 size-5 flex-none text-gray-900 dark:text-white"
// 									/>
// 									<span>
